      ...
      <section class="py-20 bg-white">
        <div class="container max-w-6xl mx-auto">
          ...
          <div class="grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0">
            <div @click="selectLevel(course)" v-for="course in courses" :key="course.id" class="mx-5 flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden border-2 border-indigo-200 hover:bg-gray-100 rounded-xl shadow-md cursor-pointer">
