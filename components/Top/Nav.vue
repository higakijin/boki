  ...
  <section class="w-full px-8 text-gray-700 bg-white">
    <div class="container flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
      <div class="relative flex flex-col md:flex-row">
        <NuxtLink to="/" class="flex items-center mb-5 text-gray-900 lg:w-auto lg:items-center lg:justify-center md:mb-0">
      ...
      <div class="inline-flex items-center ml-5 space-x-6 lg:justify-end">
        ...
        <NuxtLink to="/signup" class="inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600">
          Sign up
        </NuxtLink>
      </div>
    </div>
